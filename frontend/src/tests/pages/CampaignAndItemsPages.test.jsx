...
const blessingItems = {
  ...
  cartographersInsight: { key: 'guiding_light', name: "Guiding Light", description: 'map', requires_target: false },
...
const curseItems = {
  ...
  edictOfCompulsion: { key: 'hex_of_compulsion', name: 'Hex of Compulsion', description: 'edict', requires_target: true, payload_type: 'word' },
  vowelVoodoo: { key: 'vowel_voodoo', name: 'Vowel Voodoo', description: 'vowels', requires_target: true },
  veilOfObscuredSight: { key: 'blinding_brew', name: 'Blinding Brew', description: 'veil', requires_target: true },
};
