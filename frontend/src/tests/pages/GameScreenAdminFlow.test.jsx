  ...
  const queues = {
    ...
    '/api/admin/effects': [
      makeResponse([
        ...
        { key: 'blinding_brew', name: 'Blinding Brew', category: 'curse', affects_others: true, payload_type: 'side' },
        { key: 'twin_fates', name: 'Twin Fates', category: 'blessing', affects_others: false, payload_type: null },
        { key: 'vowel_vision', name: 'Vowel Vision', category: 'blessing', affects_others: false, payload_type: null },
